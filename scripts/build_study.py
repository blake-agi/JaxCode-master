...
def build_dashboard() -> int:
    ...
    lines.append("Generated by `scripts/build_study.py` from `attempts.csv` / `problems.csv` / "
                  "`mistakes.csv` / `tries.csv`. Do not edit by hand — re-run the script instead.")
    lines.append("")
    lines.append("| # | Task | Tag | Difficulty | Freq | Attempts | Try | Solved | Mistakes |")
    lines.append("|---|---|---|---|---|---|---|---|---|")
    for tid in tasks:
        p = problems.get(tid, {})
        ...
        lines.append(
            ...
            f"{frequency} | {n_attempts} | {try_count} | {solved} | {n_mistakes} |"
        )
